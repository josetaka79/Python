...
# Import all supporting classes from other files
...
class AlienInvasion:
    ...
    def __init__(self):
        ...
        # Game should start INACTIVE until Play is clicked
        self.game_active = False  # FIXED: changed from True to False
